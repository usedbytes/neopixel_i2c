...
SRC = $(TARGET).c i2c/i2c_machine.c ws2812/light_ws2812_AVR/Light_WS2812/light_ws2812.c
...
-Wa,-adhlns=$(<:.c=.lst) \
$(patsubst %,-I%,$(EXTRAINCDIRS)) -DF_CPU=8000000
...
AVRDUDE_FLAGS = -p $(MCU) -c $(AVRDUDE_PROGRAMMER) -P $(AVRDUDE_PORT) -q
